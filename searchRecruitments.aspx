<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="searchRecruitments.aspx.vb" Inherits="GMTC2022.searchRecruitments" %>
   ...
   <title></title>
    ...
    <script type="text/javascript"> 
        ...
        $(document).ready(function () {
            $(<%=Gov.ClientID%>).SumoSelect({placeholder:'الجميع'});
            $(<%=DriveLicType.ClientID%>).SumoSelect({ placeholder: 'الجميع' });
            ...
            parameter.add_endRequest(function () {
                $(<%=Gov.ClientID%>).SumoSelect();
                $(<%=DriveLicType.ClientID%>).SumoSelect();
                $("#G1AcceptanceDate").datepicker({ format: 'yyyy-mm-dd', changeMonth: true, changeYear: true, showRightIcon: true });
                $("#G1AcceptanceDateSearch").datepicker({ format: 'yyyy-mm-dd', changeMonth: true, changeYear: true, showRightIcon: true });
      });
        });
    ...
    <form id="form1" runat="server" dir="rtl">
        ...
        <div class="container p-3  mt-4 border btn-info">
            <div align="right" style="color: whitesmoke">
                <h4>ادارة طلبات التجنيد/الكفاءات</h4>
            </div>
        </div>
                ...
                <ContentTemplate>
                    <div class="row " align="right">
                        ...
                        <div class="col-sm-3 mt-3">
                            ...
                            <asp:ListBox ID="Gov" SelectionMode="Multiple" CssClass="form-control mt-3" runat="server">
                        ...
                        <div class="col-sm-3  mt-3">
                            ...
                            <label for="SecurityForces">رخصة قيادة </label>
                            <asp:ListBox SelectionMode="Multiple" ID="DriveLicType" CssClass="form-control" runat="server">
                                ...
                                <asp:ListItem>خصوصي</asp:ListItem>
                                ...
                                <asp:ListItem>شحن خفيف</asp:ListItem>
                    ...
                    <div class="row mt-3 mb-3" align="right">
                        ...
                        <div class="col-sm-3">
                            ...
                            <label for="SecurityForces">العمر: اكبر من </label>
                            <asp:TextBox ID="Age" runat="server" CssClass="form-control" onkeypress="return validateNumber(event)"></asp:TextBox>

                        </div>

                        <div class="col-sm-3">

                            <label for="SecurityForces">العمر: اقل من </label>
                            <asp:TextBox ID="AgeTo" runat="server" CssClass="form-control" onkeypress="return validateNumber(event)"></asp:TextBox>
                    ...
                    <div class="row mt-3 " align="right">
                        ...
                        <div class="col-sm">
                            <label for="Acceptance">القبول </label>
                            <asp:DropDownList ID="Acceptance" CssClass="form-control mt-3" runat="server">
                                <asp:ListItem Value="-1">الجميع</asp:ListItem>
                                <asp:ListItem Value="1">المجموعة الاولى</asp:ListItem>
                                <asp:ListItem Value="2">المجموعة الثانية</asp:ListItem>
                                <asp:ListItem Value="3">قبول نهائي</asp:ListItem>
                                <asp:ListItem Value="4">مرفوض</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-sm">
                            <label for="G1AcceptanceDateSearch">تاريخ القبول </label>
                            <asp:TextBox CssClass="form-control mt-3" ID="G1AcceptanceDateSearch" runat="server"></asp:TextBox>
                        </div>

                        <div class="col-sm-6">
                            <label for="Gov">الاعلان </label>
                            <asp:DropDownList ID="announcementId"
                                DataSourceID="SqLAnnouncements" DataTextField="Name" DataValueField="Id" CssClass="form-control mt-3" runat="server"  >
                    ...
                    <div class="row p-2 mt-3" align="right">
                    ...
                    <div class="row p-2" align="right">
                        <div class="col">
                            <asp:Label ID="result_" runat="server" Text=""></asp:Label>
                        </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="Requestes" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                DataSourceID="Sqlrecruitment" EmptyDataText="No result found...." AllowPaging="True" PageSize="20">
        ...
        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
            <ContentTemplate>
                <asp:SqlDataSource ID="Sqlrecruitment" runat="server"
                    ConnectionString="<%$ ConnectionStrings:ConnectionString_ %>"
                    ProviderName="System.Data.SqlClient" SelectCommand="SELECT Id,age, FName +' ' + sName +' ' + tName +' ' + lName as FullName,Gov,Locality,Gender,email,MS,[weight],[Hight],[DocCompleted],[GeneralCompleted],[MedicalCompleted],[fitnessComleted],[ECompleted],[PersonalCompleted]  FROM recruitments"></asp:SqlDataSource>

                <asp:SqlDataSource ID="SqLAnnouncements" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString_ %>" ProviderName="System.Data.SqlClient" SelectCommand="select [DateFrom] + ' -- ' +Name  as Name,[Id]  FROM  Announcements where type='تجنيد' order by DateFrom Desc "></asp:SqlDataSource>
