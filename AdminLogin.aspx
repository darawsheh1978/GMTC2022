<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminLogin.aspx.vb" Inherits="GMTC2022.AdminLogin" %>
...
<body>
    <form id="form1" runat="server" dir="rtl">
        ...
        <div class="container p-2  mt-4 border btn-Primary">
            <div align="center" style="color: whitesmoke">
                <h3>ادارة البوابة الالكترونية    </h3>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="row mt-5 ">
                            <div class="col-sm-5 mt-3"">
                                <asp:TextBox ID="txtUser" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CssClass="form-control" Font-Size="14pt" placeholder="اسم المستخدم" required="" oninput="this.setCustomValidity('')" oninvalid="this.setCustomValidity('هذا الحقل ضروري')"></asp:TextBox>
                            </div>
                            <div class="col-sm-5 mt-3"">
                            ...
                            <div class="col-sm-2 mt-3">
                                <asp:Button ID="BtnLogin" runat="server" CssClass="btn btn-danger" data-target="#exampleModalLong" data-toggle="modal" Text="الدخول" Width="100%" />
                            </div>
