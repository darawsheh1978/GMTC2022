<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CheckGradeNew.aspx.vb" Inherits="GMTC2022.CheckGradeNew" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="row mt-2" style="color: #457B9D">
                                        ...
                                        <div class="col-sm">
                                            <asp:Label ID="lblheader" CssClass="btn btn-warning btn-block"  runat="server" Text="الادخال من قبل مدراء النظام فقط"  Font-Size="14pt"></asp:Label>
                                        </div>
                                    </div>
